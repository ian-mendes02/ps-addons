        ...
        <div id="ps-created-discounts">
            ...
            <div>
                <?php foreach (PS_Discount_Manager::get_discounts() as $discount) : ?>
                    <div class="ps-discount-tile ps-collapsible" data-discount-id="<?php echo esc_attr($discount->id); ?>">
                        <div class="ps-collapsible-header">
                        ...
                        <div class="ps-collapsible-content"></div>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
